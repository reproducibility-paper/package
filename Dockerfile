...
RUN git clone https://github.com/reproducibility-paper/package.git /On-the-Reproducibility

RUN rm -rf /On-the-Reproducibility/section-2/reproducibility-scanner && \
  	git clone --recurse-submodules -j5 https://github.com/reproducibility-paper/reproducibility-scanner.git /On-the-Reproducibility/section-2/reproducibility-scanner || :
